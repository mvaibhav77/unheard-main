...
const TextareaContainer = ({
  ...
  return (
    <div
      className="relative w-[1280px] h-[528px] shrink-0 text-left text-51xl text-gray-300 font-montserrat"
      style={footer1Style}
    >
      <img
      ...
      <div
        className="absolute top-[43px] left-[698px] w-[505px] h-[402px] text-center text-41xl"
