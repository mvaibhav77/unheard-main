    ...
    <div className="relative bg-lavenderblush-200 w-full h-[810px] overflow-hidden text-center text-5xl text-white font-montserrat">
      ...
      <div className="absolute top-[72px] left-[88px] w-[1104.18px] h-[706px] text-left text-25xl text-gray-200">
        ...
        <div className="absolute top-[81px] left-[136px] w-[600px] h-[600px]">
          <div className="absolute top-[0px] left-[0px] rounded-xl bg-lavenderblush-100 w-[600px] h-[600px]" />
          <div
            className="absolute top-[12px] left-[425px] rounded-mini bg-gainsboro-200 w-[162px] h-[182px] cursor-pointer"
        ...
        <ChatContainer dimensionsText="/add3.svg" />
      </div>
    </div>
  );
};
