      ...
      <div className="absolute top-[72px] left-[88px] w-[1104.18px] h-[706px] text-left text-25xl text-gray-200">
        ...
        <div className="absolute top-[81px] left-[136px] w-[600px] h-[600px]">
          ...
          <div className="absolute top-[526px] left-[194px] w-[211px] h-[57px]">
            ...
            <div className="absolute top-[0px] left-[154px] w-[57px] h-[57px]">
              <div className="absolute top-[0px] left-[0px] rounded-sm bg-mistyrose-200 shadow-[0px_0.5px_1px_#e14343] [backdrop-filter:blur(4px)] w-[57px] h-[57px]" />
              <img
            ...
            <div className="absolute top-[0px] left-[154px] rounded-mini bg-gray-500 w-[57px] h-[57px]" />
            <img
              className="absolute top-[9.98px] left-[163.41px] w-[40.57px] h-[39.6px] cursor-pointer"
              alt=""
              src="/line-12.svg"
        ...
        <ChatContainer dimensionsText="/add1.svg" />
      </div>
    </div>
  );
};
