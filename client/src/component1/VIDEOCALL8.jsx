...
const VIDEOCALL8 = () => {
  ...
  const onAudioContainerClick = useCallback(() => {
    navigate("/video-call5");
  }, [navigate]);
      ...
      <div className="absolute top-[72px] left-[88px] w-[1104.18px] h-[706px] text-left text-25xl text-gray-200">
        ...
        <div className="absolute top-[81px] left-[136px] w-[600px] h-[600px]">
          ...
          <div className="absolute top-[526px] left-[194px] w-[211px] h-[57px]">
            ...
            <div
              className="absolute top-[0px] left-[0px] w-[57px] h-[57px] cursor-pointer"
        ...
        <ChatContainer dimensionsText="/add4.svg" />
      </div>
    </div>
  );
};

export default VIDEOCALL8;
